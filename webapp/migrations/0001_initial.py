    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(1, 'Cooking'), (3, 'On the way'), (2, 'Ready'), (4, 'Delivered')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='webapp.Meal')),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_details', to='webapp.Order')),
            ],
        ),
        migrations.CreateModel(
            name='Restaurant',
